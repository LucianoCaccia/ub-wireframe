...
function popupub (URL){
   window.open(URL,"popupub","width=761,height=641,location=0,toolbar=0,scrollbars=0")
}
</script> 
      ...
      <tr>
		...
		<table width="780" border="0" align="left" cellpadding="0" cellspacing="0">
          <tr>
			...
			<br>
			<!-- Galería UB de imágenes -->
			<div align="center">
			<a href="javascript:popupub('../../slideshow/galeria_ub.htm')"><img src="../../slideshow/banner.jpg" alt="Galería de imágenes de la Universidad de Belgrano" border="0"></a>
			</div>
			<!-- Fin de Galería UB de imágenes -->
  ...
  <tr>
	...
	<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
		...
		<!--**** -->				
				<h2 class="acc_trigger1"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('trabajos_alumnos','','../../imagenes/img/pilares/trabajos_alumnos2.jpg',1)"><img src="../../imagenes/img/pilares/trabajos_alumnos.jpg" name="trabajos_alumnos" width="301" height="33" border="0" id="trabajos_alumnos" /></a></h2>
				<div class="acc_container1">
					<div class="block">
					<!--Content Goes Here-->
						<div class="trabajos"><A HREF="javascript:abrirVer('imagenes/fotos/caratula_detalles.jpg')"><img src="imagenes/arq_trabajos.jpg" height="401" border="0"/></A><br></div>
					</div>
				</div>
		...
		<!--**** -->				
				...
				<div class="acc_container2">
					<div class="block">
					<!--Content Goes Here-->
						<div class="edu_inter"><img src="../../imagenes/marcas_empresas.jpg" /></div>
					</div>
				</div>
		...
		<!--**** -->				
				...
				<h2 class="acc_trigger3"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Imagen26','','../../imagenes/img/pilares/sub_doble_arq2.jpg',1)"><img src="../../imagenes/img/pilares/sub_doble_arq.jpg" name="Imagen26" width="301" height="33" border="0" id="Imagen26" /></a></h2>
				<div class="acc_container3">
					<div class="block">
					<!--Content Goes Here-->
							...
							<tr><td>&nbsp;</td></tr>
				              <tr>
								<td align="left"><p><span class="bold12">ITALIA</span><br />
				                    ...
				                    <span class="bold12">&gt; </span><a href="http://www.iuav.it/homepage/" target="_blank" class="link_block_sin_negrita">La Università IUAV di Venecia, Facoltà di Architecttura</a><br />
